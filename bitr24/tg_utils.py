...
def portal2(chat):
    ...
    if str(bx24.chat_id) in Bx24.last_bindings.keys() and '/AUTH' not in bx24.message:   # Есть запись и не авторизация.
        print('-------------- Точка 1(portal2). Есть запись')
        ...
        print('-------------- Точка 1(portal2). Нет записи или запрос авторизации')
        if '/AUTH' in bx24.message:                 # В сообщение запрос на авторизацию или ответ от авторизации.
            print('-------------- Точка 2(portal2). В сообщении /AUTH')
            ...
            print('-------------- Точка 2(portal2). В сообщении нет /AUTH')
    return answer
